...
Write-Output ""
Write-Output "   Web app stack:"
Write-Output "   > Reverse proxy Nginx server"
Write-Output "   > Node.js web application"
Write-Output "   > PostgreSQL database"
Write-Output ""
Write-Output "   Monitoring stack:"
Write-Output "   > Telegraf/Prometheus/Grafana pipeline for monitoring server's metrics"
Write-Output "   > Process_exporter/Prometheus/Grafana pipeline for monitoring server's processes"
Write-Output "   > Postgres_exporter/Prometheus/Grafana pipeline for monitoring PostgreSQL database"
Write-Output "   > Prom-client/Prometheus/Grafana pipeline for monitoring Node.js metrics"
Write-Output "   > Custom 'Log_pusher'/Loki/Grafana pipeline for monitoring server's logs"
Write-Output ""
