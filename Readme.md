...
graph TD;
    ...
    S2 --> T[Create Docker Compose override file]
    T --> U[Set up cron jobs for Docker containers' updates]
...
graph TD;
    ...
    H -- Login succeeded --> J[Create Docker Compose override file]
    
    J --> K[Setup Docker Compose cron jobs]
    ...
    P1 --> P2[Pull container]
    P2 --> P3[Build with override file]
    P3 --> P4[Start container]
    
    N --> Q1[Setup cron job for 'frontend' container]
    Q1 --> Q2[Pull container]
    Q2 --> Q3[Build with override file]
    Q3 --> Q4[Start container]

    N --> R1[Setup cron job for 'gateway' container]
    R1 --> R2[Pull container]
    R2 --> R3[Build with override file]
